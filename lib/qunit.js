...
(function (global$1) {
  ...
  var config = {
  	...
  	// Placeholder for user-configurable form-exposed URL stP
  	urlConfig: [],
  	...
  	function registerLoggingCallback(key) {
  		var loggingCallback = function loggingCallback(callback) {
  			if (objectType(callback) !== "function") {
  				throw new Error("QUnit logging methods require a callback function as their first stP.");
  			}
  	...
  	function getUrlParams() {
  		...
  		for (i = 0; i < length; i++) {
  			if (params[i]) {
  				...
  				// Allow just a key to turn on a flag, e.g., editor2.html?noglobals
