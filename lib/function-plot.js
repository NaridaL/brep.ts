(function (f) {
	...
	return function e(t, n, r) {
		...
		}, {"built-in-math-eval": 23, extend: 28, "interval-arithmetic-eval": 31}],
		...
		}, {"../datum-defaults": 2, "../graph-types/polyline": 7, "./eval": 11, extend: 28}],
		...
		}, {extend: 28, "integrate-adaptive-simpson": 30, "key-pressed": 49, keydown: 50}],
		...
		}, {extend: 28, "key-pressed": 49, keydown: 50}],
		...
		}, {"../helpers/eval": 11, "../utils": 22, clamp: 26, linspace: 51}],
		20: [function (require, module, exports) {
			...
			module.exports = sampler
		}, {"../helpers/eval": 11, "../utils": 22, "interval-arithmetic-eval": 31}],
		21: [function (require, module, exports) {
			...
			module.exports = function (config) {
				config = extend({
					xLine: false, yLine: false, renderer: function (x, y) {
						return "(" + x.toFixed(3) + ", " + y.toFixed(3) + ")"
					}, owner: null
				}, config);
				var MARGIN = 20;
		...
		}, {"./globals": 4, "./helpers/eval": 11, "./utils": 22, clamp: 26, extend: 28}],
		...
		}, {"./globals": 4, linspace: 51, log10: 52, logspace: 53}],
		...
		}, {"./adapter": 32, "./policies": 34, "interval-arithmetic": 35, "math-codegen": 54}],
		...
		35: [function (require, module, exports) {
			...
			"./lib/constants": 36,
			"./lib/interval": 37,
			"./lib/operations/algebra": 38,
			"./lib/operations/arithmetic": 39,
			"./lib/operations/misc": 41,
			"./lib/operations/relational": 42,
			"./lib/operations/trigonometric": 43,
			"./lib/operations/utils": 44,
			"./lib/polyfill": 45,
			"./lib/round-math": 46,
			"xtend/mutable": 85
		}],
		...
		}, {"./operations/utils": 44, "./round-math": 46}],
		...
		}, {"../constants": 36, "../interval": 37, "../round-math": 46, "./division": 40, "./utils": 44}],
		...
		}, {"../constants": 36, "../interval": 37, "../round-math": 46, "./utils": 44}],
		41: [function (require, module, exports) {
			...
			module.exports = misc
		}, {"../constants": 36, "../interval": 37, "../round-math": 46, "./arithmetic": 39, "./utils": 44}],
		...
		}, {"./Interpreter": 56, extend: 28, "mr-parser": 68}],
		56: [function (require, module, exports) {
			...
			"./node/ArrayNode": 59,
			"./node/AssignmentNode": 60,
			"./node/ConditionalNode": 61,
			"./node/ConstantNode": 62,
			"./node/FunctionNode": 63,
			"./node/OperatorNode": 64,
			"./node/SymbolNode": 65,
			"./node/UnaryNode": 66,
			extend: 28
		}],
		...
		}, {"./lib/Lexer": 69, "./lib/Parser": 70, "./lib/node/": 81}],
		...
		70: [function (require, module, exports) {
			...
			"./Lexer": 69,
			"./node/ArrayNode": 71,
			"./node/AssignmentNode": 72,
			"./node/BlockNode": 73,
			"./node/ConditionalNode": 74,
			"./node/ConstantNode": 75,
			"./node/FunctionNode": 76,
			"./node/OperatorNode": 78,
			"./node/SymbolNode": 79,
			"./node/UnaryNode": 80,
			"./token-type": 82
		}],
		...
		84: [function (require, module, exports) {
			var ua = typeof window !== "undefined" ? window.navigator.userAgent : "", isOSX = /OS X/.test(ua), isOpera = /Opera/.test(ua), maybeFirefox = !/like Gecko/.test(ua) && !isOpera;
		...
		}, {"base64-js": 86, ieee754: 90, isarray: 88}],
