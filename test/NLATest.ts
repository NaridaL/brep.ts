...
QUnit.test('EllipseCurve.isInfosWithBezier2D()', function (assert, m4) {
...
registerTests({
	...
	'EllipseCurve.prototype.isInfosWithEllipse'(assert) {
	...
	'CylinderSurface.prototype.isCurvesWithSurface'(assert) {
	...
	'CylinderSurface.prototype.loopContainsPoint'(assert) {
