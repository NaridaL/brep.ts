...
QUnit.test( "two faces cutting each other in the middle", function( assert ) {
	...
	assert.doTest(face, face2, [StraightEdge.throughPoints(V(1, 2), V(10, 2))], [V(10, 2)])

	var face3 = PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).rotateX(PI / 2).translate(1, 2, -3)
	assert.doTest(face, face3, [StraightEdge.throughPoints(V(1, 2), V(6, 2))], [])
});
QUnit.test( "face touching edge of test face with its middle", function( assert ) {
	var face = PlaneFace.forVertices(P3.XY, [V(0, 0), V(10, 0), V(10, 10), V(0, 10)])
	var face2 = PlaneFace.forVertices(P3.XY, [V(0, 0), V(12, 0), V(12, 10), V(0, 10)]).rotateX(PI/2).translate(-1, 0, -5)
	assert.doTest(face, face2, [], [V(0, 0), V(10, 0)]) // StraightEdge.throughPoints(V(0, 0), V(10, 0))
	assert.doTest(face, face2.flipped(), [], [])
});
QUnit.test( "testing V-shape with spine touching middle of test face", function( assert ) {
	var face = PlaneFace.forVertices(P3.XY, [V(-10, -10), V(10, -10), V(10, 10), V(-10, 10)])
	var brep = new B2([
	...
	assert.doTest(face, brep.rotateX(-PI/2), [], [])
	assert.doTest(face, brep.rotateX(-PI/2).flipped(), [StraightEdge.throughPoints(V(0, 0), V(5, 0)), StraightEdge.throughPoints(V(5, 0), V(0, 0))], [])
});
QUnit.test( "V-shape splitting test face at spine", function( assert ) {
	...
	assert.doTest(face, brep, [StraightEdge.throughPoints(V(0, 0), V(5, 0))], [])
	assert.doTest(face, brep.flipped(), [StraightEdge.throughPoints(V(5, 0), V(0, 0))], [])
});
QUnit.test( "V-shape with spine parallel to test face normal; touching test face edge", function( assert ) {
	var face = PlaneFace.forVertices(P3.XY, [V(-20, 0), V(20, 0), V(20, 10), V(-20, 10)])
	var brep = new B2([
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).flipped().rotateX(-PI/4),
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).rotateX(PI/4)
	]).rotateY(PI/2).translate(0, 0, 2)

	assert.doTest(face, brep, [StraightEdge.throughPoints(V(0, 0), V(5 * sqrt(2), 5 * sqrt(2))), StraightEdge.throughPoints(V(-5 * sqrt(2), 5 * sqrt(2)), V(0, 0))], [])
...
QUnit.test( "testing V-shape with spine touching test face, overlapping edge of test face", function( assert ) {
	var face = PlaneFace.forVertices(P3.XY, [V(-10, -10), V(2, -10), V(2, 10), V(-10, 10)])
	var brep = new B2([
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).flipped(),
	...
	assert.doTest(face, brep.rotateX(-PI/4), [StraightEdge.throughPoints(V(0, 0), V(2, 0))], [V(2, 0)])
	assert.doTest(face, brep.rotateX(-PI/4).flipped(), [StraightEdge.throughPoints(V(2, 0), V(0, 0))], [V(2, 0)])
	assert.doTest(face, brep.rotateX(-PI/4 * 3), [], [])
	assert.doTest(face, brep.rotateX(-PI/4 * 3).flipped(), [StraightEdge.throughPoints(V(2, 0), V(0, 0)), StraightEdge.throughPoints(V(0, 0), V(2, 0))], [])
});
QUnit.test( "testing V-shape with spine touching test face, touching edge of test face", function( assert ) {
	var face = PlaneFace.forVertices(P3.XY, [V(-10, -10), V(5, -10), V(5, 10), V(-10, 10)])
	var brep = new B2([
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).flipped(),
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).rotateX(PI/2)
	])
	...
	assert.doTest(face, brep.rotateX(PI/4), [], [])
	assert.doTest(face, brep.rotateX(PI/4).flipped(), [], [])
	assert.doTest(face, brep.rotateX(-PI/4), [StraightEdge.throughPoints(V(0, 0), V(5, 0))], [V(5, 0)])
	assert.doTest(face, brep.rotateX(-PI/4).flipped(), [StraightEdge.throughPoints(V(5, 0), V(0, 0))], [V(5, 0)])
	assert.doTest(face, brep.rotateX(-PI/4 * 3), [], [])
	assert.doTest(face, brep.rotateX(-PI/4 * 3).flipped(), [StraightEdge.throughPoints(V(5, 0), V(0, 0)), StraightEdge.throughPoints(V(0, 0), V(5, 0))], [])
});
QUnit.test( "testing V-shape with spine touching test face edge middle", function( assert ) {
	var face = PlaneFace.forVertices(P3.XY, [V(-10, 0), V(10, 0), V(10, 10), V(-10, 10)])
	var brep = new B2([
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).flipped(),
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).rotateX(PI/2)
	])
	...
	assert.doTest(face, brep.rotateX(PI/4), [], [])
	assert.doTest(face, brep.rotateX(PI/4).flipped(), [], [V(0, 0), V(5, 0)]) // StraightEdge.throughPoints(V(0, 0), V(5, 0)), StraightEdge.throughPoints(V(0, 0), V(5, 0))
	assert.doTest(face, brep.rotateX(-PI/4), [], [V(0, 0), V(5, 0)]) // StraightEdge.throughPoints(V(0, 0), V(5, 0)), StraightEdge.throughPoints(V(0, 0), V(5, 0))
	assert.doTest(face, brep.rotateX(-PI/4).flipped(), [], [])
	assert.doTest(face, brep.rotateX(-PI/4 * 3), [], [])
	assert.doTest(face, brep.rotateX(-PI/4 * 3).flipped(), [], [V(0, 0), V(5, 0)]) // StraightEdge.throughPoints(V(0, 0), V(5, 0)), StraightEdge.throughPoints(V(0, 0), V(5, 0))
});
QUnit.test( "testing V-shape with spine overlapping test face edge", function( assert ) {
	var face = PlaneFace.forVertices(P3.XY, [V(-10, 0), V(3, 0), V(3, 10), V(-10, 10)])
	var brep = new B2([
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).flipped(),
		PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 0), V(5, 10), V(0, 10)]).rotateX(PI/2)
	])
	...
	assert.doTest(face, brep.rotateX(PI/4), [], [])
	assert.doTest(face, brep.rotateX(PI/4).flipped(), [], [V(0, 0), V(3, 0)]) // StraightEdge.throughPoints(V(0, 0), V(3, 0)), StraightEdge.throughPoints(V(0, 0), V(3, 0))
	assert.doTest(face, brep.rotateX(-PI/4), [], [V(0, 0), V(3, 0)]) // StraightEdge.throughPoints(V(0, 0), V(3, 0)), StraightEdge.throughPoints(V(0, 0), V(3, 0))
	assert.doTest(face, brep.rotateX(-PI/4).flipped(), [], [])
	assert.doTest(face, brep.rotateX(-PI/4 * 3), [], [])
	assert.doTest(face, brep.rotateX(-PI/4 * 3).flipped(), [], [V(0, 0), V(3, 0)]) // StraightEdge.throughPoints(V(0, 0), V(3, 0)), StraightEdge.throughPoints(V(0, 0), V(3, 0))
});
...
QUnit.test( " ABC V-shape with spine parallel to test face normal; touching test face corner", function( assert ) {
	...
	var face = box.faces.find(face => face.surface.plane.normal.like(V3.Z)), testBrep
	// splitting contour in base position:

	testBrep = B2.tetrahedron(V(-1, 1, 9), V(5, 1, 9), V(-1, -4, 14), V(2, -4, 10))
	...
	testBrep = B2.tetrahedron(V(-1, 1, 9), V(4, 1, 9), V(-1, -4, 14), V(-1, -4, 10)).flipped()
	assert.doTestWithBrep(face, box, testBrep, [], [V(3, 0, 10), V(0, 0, 10)],
		"face of _flipped_ tetra touches edge of testface and also intersects main volume (expect point on edge)")

	testBrep = B2.tetrahedron(V(-1, 0, 10), V(5, 0, 10), V(2, 0, 14), V(2, -4, 10))
	assert.doTestWithBrep(face, box, testBrep, [], [],
		"volumes touch edge-edge but no overlap (empty result volume; generated points dont matter)")

	testBrep = B2.tetrahedron(V(-1, 0, 10), V(5, 0, 10), V(-1, -2, 8), V(-1, 2, 8)).flipped()
	assert.doTestWithBrep(face, box, testBrep, [], [V(5, 0, 10), V(0, 0, 10)],
		"Tetrahedron is flipped, testface only touched at edge, needs point on edge as tetrahedron intersects side of volume")


	testBrep = B2.tetrahedron(V(-1, 0, 10), V(5, 0, 10), V(-1, 0, 14), V(-1, -4, 9)).flipped()
	assert.doTestWithBrep(face, box, testBrep, [], [],
...
QUnit.test( " coplanar things", function( assert ) {
	...
	testBrep = B2.tetrahedron(V(-1, -1, 10), V(-1, 5, 10), V(5, -1, 10), V(-1, -1, 5)).flipped()
	assert.doTestWithBrep(face, box, testBrep, [StraightEdge.throughPoints(V(0, 4, 10), V(4, 0, 10))], [V(0, 4, 10), V(4, 0, 10)],
		"cut off corner of box with flipped tetra (anti)coplanar to test face")

	testBrep = B2.tetrahedron(V(-1, -1, 10), V(-1, 5, 10), V(4, 0, 10), V(-1, -1, 5)).flipped()
	assert.doTestWithBrep(face, box, testBrep, [StraightEdge.throughPoints(V(0, 4, 10), V(4, 0, 10))], [V(0, 4, 10), V(4, 0, 10)],
		"cut off corner of box with flipped tetra (anti)coplanar to test face")

	testBrep = B2.tetrahedron(V(1, 0, 10), V(1, 5, 10), V(4, 0, 10), V(-1, -1, 5)).flipped()
	assert.doTestWithBrep(face, box, testBrep,
		[StraightEdge.throughPoints(V(1, 0, 10), V(1, 5, 10)), StraightEdge.throughPoints(V(1, 5, 10), V(4, 0, 10))],
		[V(1, 0, 10), V(4, 0, 10)],
		"cut off corner of box with flipped tetra (anti)coplanar to test face")

	testBrep = B2.tetrahedron(V(0, 0, 10), V(0, 5, 10), V(5, 0, 10), V(0, 0, 5)).flipped()
	assert.doTestWithBrep(face, box, testBrep,
		[StraightEdge.throughPoints(V(0, 5, 10), V(5, 0, 10))],
		[V(0, 5, 10), V(5, 0, 10)],
		"cut off corner of box with flipped tetra (anti)coplanar to test face")

	testBrep = B2.tetrahedron(V(0, 0, 10), V(-1, 5, 10), V(5, -1, 10), V(-1, -1, 5)).flipped()
	assert.doTestWithBrep(face, box, testBrep, [StraightEdge.throughPoints(V(0, 4, 10), V(4, 0, 10))], [V(0, 4, 10), V(4, 0, 10)],
		"cut off corner of box with flipped tetra (anti)coplanar to test face")

	testBrep = B2.tetrahedron(V(0, 0, 10), V(1, 5, 10), V(5, 1, 10), V(0, 0, 5)).flipped()
	assert.doTestWithBrep(face, box, testBrep,
...
QUnit.test( " coplanar things 2", function( assert ) {
	...
	testBrep = B2.tetrahedron(V(-1, -1, 10), V(-1, 5, 10), V(5, -1, 10), V(-1, -1, 5))
	assert.doTestWithBrep(face, box, testBrep, [StraightEdge.throughPoints(V(0, 4, 10), V(4, 0, 10))], [V(0, 4, 10), V(4, 0, 10)],
		"cut off corner of box with flipped tetra (anti)coplanar to test face")

	testBrep = B2.tetrahedron(V(-1, -1, 10), V(-1, 5, 10), V(5, -1, 10), V(-1, -1, 5)).flipped()
	assert.doTestWithBrep(face, box.flipped(), testBrep, [StraightEdge.throughPoints(V(0, 4, 10), V(4, 0, 10))], [V(0, 4, 10), V(4, 0, 10)],
		"cut off corner of box with flipped tetra (anti)coplanar to test face")
...
QUnit.test( "test assembly", function( assert ) {
	var baseFace = PlaneFace.forVertices(P3.XY, [V(0, 0), V(10, 0), V(10, 10), V(0, 10)])

	var extrude = B2.extrudeVertices([V(5, -1), V(2, 2), V(8, 2)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result = PlaneFace.forVertices(P3.XY, [V(0, 0), V(4, 0), V(2, 2), V(8, 2), V(6, 0), V(10, 0), V(10, 10), V(0, 10)])
	assert.doTest2(baseFace, extrude, [result], "volume cuts edge of test face (twice)")

	var extrude2 = B2.extrudeVertices([V(5, 0), V(2, 3), V(8, 3)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result2 = PlaneFace.forVertices(P3.XY, [V(0, 0), V(10, 0), V(10, 10), V(0, 10)], [V(5, 0), V(2, 3), V(8, 3)])
	...
	var result4 = PlaneFace.forVertices(P3.XY, [V(0, 0), V(10, 0), V(10, 10), V(0, 10)], [V(5, 2), V(0, 2)])


	var extrude5 = B2.extrudeVertices([V(0, 0), V(3, 2), V(2, 3)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result5 = PlaneFace.forVertices(P3.XY, [V(0, 0), V(2, 3), V(3, 2), V(0, 0), V(10, 0), V(10, 10), V(0, 10)])
	assert.doTest2(baseFace, extrude5, [result5], "volume touches inside of test face corner")

	var extrude6 = B2.extrudeVertices([V(1, 0), V(3, 0), V(8, 10)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result6 = [PlaneFace.forVertices(P3.XY, [V(0, 0), V(1, 0), V(8, 10), V(3, 0), V(10, 0), V(10, 10), V(0, 10)])]
	assert.doTest2(baseFace, extrude6, result6, "volume touches inside of test face corner")

	var extrude7 = B2.extrudeVertices([V(1, 0), V(3, 0), V(8, 10), V(7, 10)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result7 = [PlaneFace.forVertices(P3.XY, [V(0, 0), V(1, 0), V(7, 10), V(0, 10)]), PlaneFace.forVertices(P3.XY, [V(10, 10), V(8, 10), V(3, 0), V(10, 0)])]
...
QUnit.test( "test assembly holes", function( assert ) {
	...
	var extrude7 = B2.extrudeVertices([V(0, 0), V(5, 8), V(8, 5)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result7 = [PlaneFace.forVertices(P3.XY, [V(0, 0), V(5, 8), V(8, 5), V(0, 0), V(10, 0), V(10, 10), V(0, 10)])]
	assert.doTest2(baseFace, extrude7, result7, "volume touches inside of test face corner")

	var extrude8 = B2.extrudeVertices([V(1, 1), V(1, -1), V(-1, 1)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result8 = [PlaneFace.forVertices(P3.XY, [V(1, 0), V(10, 0), V(10, 10), V(0, 10), V(0, 1), V(1, 1)])]
	assert.doTest2(baseFace, extrude8, result8, "volume touches inside of test face corner")

	var extrude9 = B2.extrudeVertices([V(-1, -1), V(1, 1), V(1, -1)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result9 = [PlaneFace.forVertices(P3.XY, [V(1, 0), V(10, 0), V(10, 10), V(0, 10), V(0, 0), V(1, 1)])]
	assert.doTest2(baseFace, extrude9, result9, "volume touches inside of test face corner")

	var extrude10 = B2.extrudeVertices([V(1, 1), V(2, 2), V(2, 1)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result10 = [PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0)], [V(1, 1), V(2, 2), V(2, 1)])]
	assert.doTest2(baseFace, extrude10, result10, "adding a hole")

	var baseFace11 = PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0)], [V(1, 1), V(2, 2), V(2, 1)])
	var extrude11 = B2.extrudeVertices([V(5, 5), V(6, 6), V(6, 5)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result11 = [PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0)], [V(1, 1), V(2, 2), V(2, 1)], [V(5, 5), V(6, 6), V(6, 5)])]
	...
	var extrude12 = B2.extrudeVertices([V(2, 1.5), V(2, 4), V(4.5, 4)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result12 = [PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0)], [V(5, 5), V(5, 1), V(1, 1), V(2, 2), V(2, 4), V(4, 4)])]
	assert.doTest2(baseFace12, extrude12, result12, "extending an existing hole")

	var baseFace13 = PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0)], [V(1, 1), V(5, 5), V(5, 1)])
	var extrude13 = B2.extrudeVertices([V(3, -1), V(4, -1), V(4, 2), V(3, 2)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result13 = [PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0), V(3, 0), V(3, 1), V(1, 1), V(5, 5), V(5, 1), V(4, 1), V(4, 0)])]
	assert.doTest2(baseFace13, extrude13, result13, "removing a hole by cutting a channel")

	var baseFace14 = PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0)], [V(1, 1), V(5, 5), V(5, 1)])
	var extrude14 = B2.extrudeVertices([V(1, 1), V(1, 5), V(5, 5)], P3.XY.flipped(), V(0, 0, 10)).translate(0, 0, -2).flipped()
	var result14 = [PlaneFace.forVertices(P3.XY, [V(10, 0), V(10, 10), V(0, 10), V(0, 0)], [V(5, 5), V(5, 1), V(1, 1), V(1, 5)])]
...
QUnit.test( "B2.prototype.minus remove half of a half-pie", function( assert ) {
	...
	{
		const testFace = pie.faces.find(face => face.surface.plane.normal.like(V3.Y.negated()) && face.edges.some(edge => edge.a.x > 1))
		const k2 = boxKnife.translate(-1, 0, 0)
		assert.doTestWithBrep(testFace, pie, k2.flipped(), [], [V3.ZERO, V(0, 0, 5)],
			"volumes touch edge-edge but no overlap (empty result volume; generated points dont matter)")
		assert.b2Equal(pie, k2, pie.minus(k2), B2.puckman(8, 90 * DEG, 5, 'pie/4'))
	}
});
QUnit.test( "B2.prototype.minus cut hole through side of pie", function( assert ) {
	...
	let result = new B2([
		...
		new PlaneFace(new PlaneSurface(new P3(V(0, 0, -1), -4)), [
			...
			StraightEdge.throughPoints(V(6, 5.291502622129181, 4), V(6, 0, 4))], [])])
...
QUnit.test( "B2.prototype.minus including ProjectedCurveSurface", function( assert ) {
	...
	let result = new B2([
		...
		new PlaneFace(new PlaneSurface(new P3(V(0, 0, -1), -4)), [
			...
			StraightEdge.throughPoints(V(6, 3.720106174228432, 4), V(6, 0, 4))], [])])
