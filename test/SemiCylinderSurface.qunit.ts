{
	registerTests('SemiCylinderSurface', {
		'loopContainsPoint with PICurve'(assert) {
		...
		// StraightEdge.throughPoints(e0.b, modface.contour[2].a), modface.contour[2], StraightEdge.throughPoints(modface.contour[2].b, e0.a)])  testZDirVolume(assert, face) testZDirVolume(assert, face.rotateY(-45 * DEG).translate(1, 0, 2)) testZDirVolume(assert, face.rotateY(90 * DEG).translate(1, 0, 2))  testZDirVolume(assert, face2) testZDirVolume(assert, face2.rotateY(-45 * DEG).translate(1, 0, 2)) testZDirVolume(assert, face2.rotateY(90 * DEG).translate(1, 0, 2))  testZDirVolume(assert, face3) testZDirVolume(assert, face3.translate(1, 0, 2))  testZDirVolume(assert, face4) testZDirVolume(assert, face4.translate(1, 0, 2)) },
