...
QUnit.test( "Face.equals", function( assert ) {
	var a = PlaneFace.forVertices(new P3(V(0, 0, 1), 0), [V(0, 0, 0), V(10, 0, 0), V(10, 10, 0), V(0, 10, 0)])
	var b = PlaneFace.forVertices(new P3(V(0, 0, 1), 0), [V(0, 10, 0), V(0, 0, 0), V(10, 0, 0), V(10, 10, 0)])
	var c = PlaneFace.forVertices(new P3(V(0, 0, -1), 0), [V(0, 0, 0), V(10, 0, 0), V(10, 10, 0), V(0, 10, 0)].slice().reverse())
...
QUnit.test( "B2.equals", function( assert ) {
	var a = B2.tetrahedron(V(5, 5, 5), V(5, 5, -5), V(10, 12, 1), V(0, 12, 1))
	var b = B2.tetrahedron(V(5, 5, 5), V(10, 12, 1), V(5, 5, -5), V(0, 12, 1))
	var c = B2.tetrahedron(V(5, 5, 5), V(12, 12, 1), V(5, 5, -5), V(0, 12, 1))
...
QUnit.test( "B2.tetrahedron", function( assert ) {
	...
	var a = B2.tetrahedron(V(5, 5, 5), V(5, 5, -5), V(9, 11, 1), V(1, 9, 0))
...
QUnit.test( "Face.prototype.containsPoint", function( assert ) {
	...
	var b = PlaneFace.forVertices(new P3(V(0, 0, 1), 0), [V(0, 10, 0), V(0, 0, 0), V(5, 0, 0), V(6, 5, 0)])
	assert.ok(b.containsPoint(V(2, 5, 0)))

	var c = PlaneFace.forVertices(new P3(V(0, 0, 1), 0), [V(0, 10, 0), V(0, 0, 0), V(5, 0, 0), V(6, 5, 0), V(10, 5, 0)])
...
QUnit.test( "splitsVolumeEnclosingFaces", function( assert ) {
	var brep = B2.tetrahedron(V(0, 0,0),V(10,0,0),V(0,10,0),V(0,0,10))
...
QUnit.test( "pointsToInside", function( assert ) {
	var face = PlaneFace.forVertices(new P3(V(0, 0, 1), 0), [V(0, 0, 0), V(10, 0, 0), V(10, 10, 0), V(0, 10, 0)])
	var v = V(10, 10, 0)
...
QUnit.test( "B2 edge/face intersection", function( assert ) {
	...
	var extrusion = B2.extrudeVertices([V(1,0),V(0, 3), V(-2, 5), V(5, 5)], P3.XY.flipped(), V(0, 0, 10), 'lol')
		.translate(0,1,1)
	var result = new B2([
...
QUnit.test( "CylinderSurface.intersectionLine", function( assert ) {
	...
	var line = L3.throughPoints(V(10, 0, 0), V(-10, 2, 10))
...
QUnit.test( "CylinderSurface.intersectionLine 2", function( assert ) {
	var cylSurface = new CylinderSurface(new EllipseCurve(V3.ZERO, V(8, 0, 0), V(0, 5, 0)), V3.Z)
	var line = L3.throughPoints(V(10, 0, 0), V(-10, 2, 10))
...
QUnit.test( "Ellipse.isPointsWithEllipse", function(assert ) {
	var c1 = EllipseCurve.circle(5), c2 = EllipseCurve.circle(5, V(3, 0))
	testEllipseIntersections(assert, c1, c2, 2)
	var verticalEllipse = new EllipseCurve(V(2, 0), V(1, 1), V(1, 10))
	testEllipseIntersections(assert, c1, verticalEllipse, 4)
	var verticalEllipse2 = new EllipseCurve(V(10, 2), V(1, 1), V(1, 10))
	...
	var test = new EllipseCurve(V(6, 1, 0), V(3, 1, 0), V(4, 0, 0))
...
QUnit.test( "cylinder surface inss", function( assert ) {
	...
	var ell = new CylinderSurface(new EllipseCurve(V(6, 1, 4), V(3, 1, 4), V(4, 0, 0)), V3.Z)
