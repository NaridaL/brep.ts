...
import { addOwnProperties, arrayFromFunction, DEG, M4, Transformable, V, V3 } from 'ts3dutils'
import { Mesh } from 'tsgl'
import { BezierCurve, Edge, EllipsoidSurface, P3, PointProjectedSurface, ProjectedCurveSurface } from '..'

skip('PointProjectedSurface', () => {
	const baseCurve = BezierCurve.graphXY(2, -3, -3, 2, -1, 2)
	const testSurface = new PointProjectedSurface(baseCurve, V(0, 0, 3), P3.XY, 1, undefined, undefined, 0, 2)
