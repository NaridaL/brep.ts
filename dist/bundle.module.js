...
class ParametricSurface extends Surface$1 {
    ...
    static isCurvesParametricImplicitSurface(ps, is, uStep, vStep = uStep, curveStepSize) {
        ...
        const curves = Curve$1.breakDownIC(mf, ps, uStep, vStep, curveStepSize, (u, v) => is.containsPoint(pf(u, v))).map(({ points, tangents }, _i) => PICurve$1.forParametricPointsTangents(ps, is, points, tangents, curveStepSize));
        return curves;
    }
...
class ConicSurface extends ParametricSurface$1 {
    ...
    transform4(m4) {
        ...
        const isometricV = (z) => new EllipseCurve$2(new V3(0, 0, z), new V3(z, 0, 0), new V3(0, z, 0));
